...
package ptwalk_rv;
  ...
  interface Ifc_ptwalk_rv# (
    ...
    interface Get#(PTW_response_splitTLB#(xlen, max_varpages, ppnsize, asidwidth )) subifc_to_tlb;
  ...
  module mkptwalk_rv#(parameter Bit#(32) hartid)(Ifc_ptwalk_rv#(xlen, paddr, max_varpages, ppnsize, 
                      subvpn, page_offset, asidwidth, svnapot))
      provisos(
    ...
    FIFOF#(PTW_response_splitTLB#(xlen, max_varpages, ppnsize, asidwidth)) ff_response <- mkSizedFIFOF(2);   // to tlb
