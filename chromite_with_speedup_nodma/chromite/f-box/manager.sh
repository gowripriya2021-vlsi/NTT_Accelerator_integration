...
if [ -z "$inc_token" ]
then
  REPO_BASE=https://gitlab.com/incoresemi/
else
  REPO_BASE=https://incoretoken:$inc_token@gitlab.com/incoresemi/
fi

DEPS_FOLDER=.

repo_list=(
  $REPO_BASE/blocks/common_bsv
  $REPO_BASE/utils/python-utils
  )
